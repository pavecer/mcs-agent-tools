...
from toolkit.core.visualizer import parse_solution_zip
from toolkit.core.renamer import safe_extractall

BEST_PRACTICES_DIR = Path(__file__).resolve().parents[2] / "best_practices"
...
_HINT_TO_KEY: dict[str, str | None] = {
    ...
    "gpt52chat": "gpt52chat",
    "GPT52Reasoning": "gpt52reasoning",
    "gpt-5.2-reasoning": "gpt52reasoning",
    "gpt52reasoning": "gpt52reasoning",
    # Claude (Anthropic external) models
    "ClaudeSonnet45": "claudesonnet45",
    "claude-sonnet-4.5": "claudesonnet45",
    "claudesonnet45": "claudesonnet45",
    "ClaudeOpus45": "claudeopus45",
    ...
    "o4-mini": "o4mini",
    "o4mini": "o4mini",
    # Below threshold or retired — not assessed
    "GPT4o": None,
    "gpt-4o": None,
    "gpt-4o-mini": None,
    "gpt-4": None,
